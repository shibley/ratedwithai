...
export const metadata: Metadata = {
  title: "ADA Title II Compliance for Local Government | RatedWithAI",
  description:
    "Meet your April 2026 ADA Title II deadline with affordable WCAG 2.1 AA scanning. Built for government budgets starting at $29/mo.",
  keywords: [
...
const features = [
  {
    ...
    description:
      "The exact standard required by ADA Title II. We test against every Level A and AA criterion so you know exactly where you stand.",
    icon: (
...
const competitors = [
  {
    name: "Siteimprove",
    price: "$300–500/mo",
    note: "Enterprise pricing, long contracts",
    highlight: false,
    warning: false,
  },
  {
  ...
  },
  {
    name: "RatedWithAI",
    price: "$29/mo",
    note: "Real WCAG scanning, continuous monitoring, no overlays",
    highlight: true,
    warning: false,
  },
];
...
const roiItems = [
  { label: "Average ADA lawsuit settlement", value: "$15,000+", color: "text-red-400" },
  { label: "Average legal fees", value: "$10,000+", color: "text-orange-400" },
  { label: "RatedWithAI annual cost", value: "$249", color: "text-emerald-400" },
];
  ...
  const jsonLd = [
    {
      ...
      "@type": "WebPage",
      name: "ADA Title II Compliance for Local Government",
      description:
        "Meet your April 2026 ADA Title II deadline with affordable WCAG 2.1 AA scanning. Built for government budgets starting at $29/mo.",
      url: "https://ratedwithai.com/government",
      publisher: {
      ...
      offers: [
        {
          ...
          billingIncrement: 1,
          unitCode: "MON",
          description: "Single site WCAG 2.1 AA scanning for government websites",
        },
        {
          "@type": "Offer",
          name: "Government Pro",
          ...
          billingIncrement: 1,
          unitCode: "MON",
          description: "Up to 5 sites — perfect for county-level government",
        },
        {
          "@type": "Offer",
          ...
          billingIncrement: 1,
          unitCode: "ANN",
          description: "Single site, annual billing — save $99",
        },
      ],
      description:
        "ADA Title II compliance scanning built for local government budgets. WCAG 2.1 AA automated testing, continuous monitoring, and actionable fix reports.",
      url: "https://ratedwithai.com/government",
    },
    {
      "@context": "https://schema.org",
      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "The ADA Title II compliance deadline for state and local government websites is April 24, 2026. All web content and mobile apps must conform to WCAG 2.1 Level AA by this date.",
          },
        },
        {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "RatedWithAI offers government-friendly pricing starting at $29/month for a single site, or $249/year with annual billing. This is significantly less than enterprise tools like Siteimprove ($300-500/mo).",
          },
        },
        {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "The DOJ has explicitly warned against relying on overlay widgets for ADA compliance. Overlays don't fix underlying accessibility issues and can actually make websites less accessible for people using assistive technology.",
          },
        },
      ],
    },
        ...
        <section className="relative z-10 mx-auto w-full max-w-6xl px-6 pb-20 pt-12">
          <div className="text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg text-slate-300 sm:text-xl">
              Your deadline is April 24, 2026. Most compliance tools cost $300+/mo.
              <br className="hidden sm:block" />
              Ours starts at <span className="font-semibold text-white">$29</span>.
            </p>
        ...
        <div className="mx-auto w-full max-w-5xl px-6 py-20">
          <div className="text-center">
            ...
            <h2 className="mt-4 text-3xl font-semibold text-white sm:text-4xl">
              50,000+ government entities face the same deadline
            </h2>
          </div>
          ...
          <div className="mx-auto mt-12 max-w-3xl">
            <div className="rounded-2xl border border-slate-800/70 bg-slate-950/60 p-8">
              ...
              <p className="mt-6 text-base text-slate-400">
                When enterprise tools charge $300–500/month, the math doesn't work
                for small governments. But the federal requirement doesn't care
                about your budget.
              </p>
            </div>
      ...
      <section className="border-t border-slate-800/70">
        <div className="mx-auto w-full max-w-5xl px-6 py-20">
          <div className="text-center">
            ...
            <h2 className="mt-4 text-3xl font-semibold text-white sm:text-4xl">
              Enterprise-grade scanning at a price
              <br className="hidden sm:block" /> that works for public budgets
            </h2>
          </div>
        ...
        <div className="mx-auto w-full max-w-5xl px-6 py-20">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-xl text-slate-300">
              Governments love annual billing — we do too. Lock in your rate and
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            ...
            <div className="relative rounded-3xl border border-sky-400/60 bg-gradient-to-br from-slate-900 via-slate-900/80 to-slate-950 p-8 shadow-xl shadow-sky-500/10">
              ...
              <div className="mt-4 rounded-xl border border-emerald-500/20 bg-emerald-500/5 px-4 py-2">
                <p className="text-sm text-emerald-300">
                  Annual: <span className="font-semibold">$749/year</span>{" "}
          ...
          <p className="mt-6 text-center text-sm text-slate-400">
            Need a quote for procurement? Email{" "}
            <a
              href="mailto:hello@ratedwithai.com?subject=Government Pricing Inquiry"
              className="text-sky-400 underline underline-offset-2 transition hover:text-sky-300"
            >
              hello@ratedwithai.com
            </a>{" "}
            — we're happy to provide W-9s and formal quotes.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto w-full max-w-4xl px-6 py-16">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-slate-300">
              Trusted by government entities working toward ADA Title II compliance
            </p>
            <p className="mt-1 text-sm text-slate-500">
              Join the growing number of municipalities choosing affordable, real accessibility scanning
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto w-full max-w-6xl px-6 py-16">
          <div className="rounded-3xl border border-slate-800/70 bg-gradient-to-r from-slate-900 via-slate-900/80 to-slate-950 p-8 text-center md:p-12">
            ...
            <p className="mx-auto mt-4 max-w-xl text-sm text-slate-400">
              No signup required. No credit card. Just enter your URL and see exactly
              where your site stands against WCAG 2.1 AA — the standard required by
              ADA Title II.
            </p>
